...
void initialisation(Chrs **dyad,int populationSize,int numWordGroup,Words *word,
   ...
   do { 
      ...
      group=(int)(numWordGroup*runif(0,1));
      ...
      dyad[popuCn][1].wordID=minSpaceWidth+(int)((maxSpaceWidth-minSpaceWidth+1)*runif(0,1));
      ...
      maxpFactor[popuCn]=MAXP_BASE+MAXP_FACTOR*((int)(MAXP_SCALE*runif(0,1)));
