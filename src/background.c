   ...
   if (MarkovOrder==0) {
      ...
      for (i=0; i<numSeq; i++) {
         ...
         for (j=0; j<seqLen[i]-3; j++) {
            rand=runif(0,1); id1=-1; id2=-1; id3=-1;
            switch (bseq[i][j]) {
               case 'a': id1=0; break; 
               case 'c': id1=1; break; 
               case 'g': id1=2; break; 
      ...
      for (i=0; i<numSeq; i++) {
         ...
         for (j=0; j<seqLen[i]-4; j++) {
            rand=runif(0,1); id1=-1; id2=-1; id3=-1; id4=-1;
            switch (bseq[i][j]) {
               case 'a': id1=0; break; 
               case 'c': id1=1; break; 
               case 'g': id1=2; break; 
      ...
      for (i=0; i<numSeq; i++) {
         ...
         for (j=0; j<seqLen[i]-5; j++) {
            rand=runif(0,1); id1=-1; id2=-1; id3=-1; id4=-1; id5=-1;
            switch (bseq[i][j]) {
               case 'a': id1=0; break; 
               case 'c': id1=1; break; 
               case 'g': id1=2; break; 
      ...
      for (i=0; i<numSeq; i++) {
         ...
         for (j=0; j<seqLen[i]-6; j++) {
            rand=runif(0,1); id1=-1; id2=-1; id3=-1; id4=-1; id5=-1; id6=-1;
            switch (bseq[i][j]) {
               case 'a': id1=0; break; 
               case 'c': id1=1; break; 
               case 'g': id1=2; break; 
      ...
      for (i=0; i<numSeq; i++) {
         ...
         for (j=0; j<seqLen[i]-7; j++) {
            rand=runif(0,1); id1=-1; id2=-1; id3=-1; id4=-1; id5=-1; id6=-1; id7=-1;
            switch (bseq[i][j]) {
               case 'a': id1=0; break; 
               case 'c': id1=1; break; 
               case 'g': id1=2; break; 
      ...
      for (i=0; i<numSeq; i++) {
         ...
         for (j=0; j<seqLen[i]-8; j++) {
            rand=runif(0,1); id1=-1; id2=-1; id3=-1; id4=-1; id5=-1; id6=-1; id7=-1; id8=-1;
            switch (bseq[i][j]) {
               case 'a': id1=0; break; 
               case 'c': id1=1; break; 
               case 'g': id1=2; break; 
